...
public class ActorRepository {
	...
	// Q7.Saving objects of type Actor to the database
	...
	// Q 8.look for objects in the database of type Actor by id
	public Optional<Actor> findById(final Long id) {
		return Optional.ofNullable(entityManager.find(Actor.class, id));
	}

	// Q9.search for objects in the Actor type database that were born after a
	// certain year (i.e. the year is a method parameter)
	...
	// 10. look for objects in the database of the Actor type, the names of which
	// end with the specified value of the String type object.
