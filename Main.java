...
public class Main {
	...
	public static void main(String[] args) {
		try {
			...
			Actor a1 = new Actor("Hritik", "Roshan", 1987, null);
			Actor a2 = new Actor("Vidyut", "Jamwal", 1979, null);

			Actor a3 = new Actor("Radhika", "Pandit", 1980, null);
			Actor a4 = new Actor("Srinidhi", "Shetty", 1975, null);
			...
			Movie m1 = new Movie("Krrish", 2006, actors1, g1);

			Movie m2 = new Movie("Bahubali", 2015, actors2, g2);
			...
			List<Actor> actors = actorRepositoty.findAllBornAfter(1985);
			...
			Movie movie = movieRepository.findMovieByName("Krrish");
			 ...
			 * 
			 * movies = movieRepository.findAll(); movies.forEach(mv ->
